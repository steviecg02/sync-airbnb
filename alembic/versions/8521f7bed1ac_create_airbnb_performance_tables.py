...
def upgrade():
    ...
    op.execute("SELECT create_hypertable('airbnb_chart_query', 'time', if_not_exists => TRUE);")
    op.create_index(
    ...
    op.execute("SELECT create_hypertable('airbnb_chart_summary', 'time', if_not_exists => TRUE);")
    op.create_index(
    ...
    op.execute("SELECT create_hypertable('airbnb_list_of_metrics', 'time', if_not_exists => TRUE);")
    op.create_index(
