...
class ChartSummary(Base):
    ...
    conversion_rate_value_change = Column(Float)
    conversion_rate_value_change_string = Column(Text)
    ...
    p3_impressions_value_change = Column(Float)
    p3_impressions_value_change_string = Column(Text)
